...
export const userLoginReducer = (state = {}, action) => {
    switch (action.type) {
        case userConstants.USER_LOGIN_REQUEST:
            return { isLoading: true, userInfo: null };
...
export const userChangePasswordReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case userConstants.USER_CHANGE_PASSWORD_FAIL:
            return { isLoading: false, isError: action.payload.message };
...
// GET FAVORITE MOVIES
export const getFavoriteMoviesReducer = (state = {likedMovies: []}, action) => {
    switch (action.type) {
